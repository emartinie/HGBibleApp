const psalmsData = [
  ...
  { day: 'Wednesday', url: 'http://audio.esvbible.org/hw/19073001-19089052.mp3', passage: 'Chapters 73-89' },
  ...
  { day: 'All', url: 'http://audio.esvbible.org/hw/19001001-19029011.mp3', passage: 'Chapters 1-150' }
];

function buildPsalms() {
  const container = document.getElementById('psalmsContent');
  container.innerHTML = psalmsData.map(p => `
    <div class="flex justify-between items-center p-3 border-b border-gray-200 rounded-lg bg-white/50 backdrop-blur-sm mb-2 dark:bg-gray-700/50 dark:border-gray-600">
